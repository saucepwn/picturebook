 ...
 */
public class PhotoTagsTransitionGenerator implements TransitionGenerator {
    ...
    private static final float MIN_RECT_FACTOR = 0.9f;
    ...
    public PhotoTagsTransitionGenerator(long duration, ArrayList<Tag> tags) {
        mDuration = duration;
        mTags = tags;
    ...
    public Transition generateNextTransition(RectF drawableBounds, RectF viewport) {
        ...
        mLastGenTrans = new Transition(srcRect, dstRect, mDuration, mTransitionInterpolator);
